...
CREATE TABLE LOAN (ID SERIAL PRIMARY KEY, VOLUME INTEGER NOT NULL REFERENCES VOLUME(ID), PUBLICATION_DATE DATE, LOAN_LATE DATE, RETURN_DATE DATE, OWNER INTEGER REFERENCES member(ID), BORROWER INTEGER NOT NULL REFERENCES member(ID), NOTE TEXT);
