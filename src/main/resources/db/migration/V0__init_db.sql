...
CREATE TABLE SHELF(ID SERIAL PRIMARY KEY, OWNER INTEGER REFERENCES MEMBER(ID), SHELF_NAME VARCHAR(50), SHELF_ADDRESS TEXT, NOTES TEXT);
...
--TEST CREATE
CREATE TABLE FIREWALKWITHME (ID SERIAL PRIMARY KEY, DESCRIPTION VARCHAR(100));
