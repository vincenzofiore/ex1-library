...
CREATE TABLE SHIELF(ID SERIAL PRIMARY KEY, OWNER INTEGER NOT NULL REFERENCES MEMBER(ID), SHIELF_NAME VARCHAR(50), SHIELF_ADDRESS TEXT, NOTES TEXT);
-- CONSTRIANTS
